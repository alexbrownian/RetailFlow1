...
| **Discord** | Full bot account posting embeds to channels (their whole UI) | **REJECTED (2026-07-06)** — our output is the Streamlit DASHBOARD only, which now includes a Signals panel showing notebook 09's BUY/SELL decisions with reasons. (Also: fintwit-bot does NOT ingest FROM Discord, and neither do we — reading other people's servers has consent/ToS problems) |
